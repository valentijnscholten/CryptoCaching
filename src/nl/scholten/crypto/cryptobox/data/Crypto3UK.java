...
//			"ZES", "ZEVEN", "ACHT", "NEGEN", "TIEN" };
	...
	public static String[] HITS = new String[] {  "CONGRATULATIONS", "TOFINDTHEBOX", "TO", "FIND", "THE", "BOX", "HAPPY", "SEARCHING", "SEARCH", //"GA", "NAAR", "NEGENDRIEEEN",  
		"DOT", "ZERO", "NUL", "ONE", "TWO", "THREE", "FOUR", "FIVE",
		"SIX", "SEVEN", "EIGHT", "NINE" };
	
	public static String[] BEGINNINGS = new String[] { "GEFELICITEERDOMDEBOXTEVINDENGANAAR", "CONGRATULATIONS" };
	public static String[] ENDINGS = new String[] { "ACHTNULTWEESUCCESMETZOEKENXXXX", "HAPPYSEARCHINGXXXX", "XXXX", "XXX", "XX", "X" }; //exclude paddings
